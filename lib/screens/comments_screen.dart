...
import 'package:plants_talk/resources/firestore_methods.dart';
import 'package:plants_talk/utils/colors.dart';
import 'package:plants_talk/utils/utils.dart';
import 'package:plants_talk/widgets/comment_card.dart';
...
class _CommentsScreenState extends State<CommentsScreen> {
  ...
  Widget build(BuildContext context) {
    final User2? user = Provider.of<UserProvider>(context).getUser;
