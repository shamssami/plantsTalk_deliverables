...
class testitem extends StatefulWidget {
  ...
  const testitem({Key? key, required this.plant}) : super(key: key);
                      ...
                      children: <Widget>[
                        ...
                        Container(
                            ...
                            child: ListView(
                              ...
                              children: <Widget>[
                                ...
                                SizedBox(width: 5.0),
                                soilType('نوع التربة ', '${widget.plant.Soil}'),
                                SizedBox(width: 20.0),
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: Center(
                              child: Text(
                                  'وقت الزراعة: ${widget.plant.planting_time}',
                                  style: TextStyle(
                                    color: Colors.black,
                                    fontFamily: 'Montserrat',
                                    fontWeight: FontWeight.bold,
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: Center(
                              child: Text(
                                  'يحتاج ${widget.plant.Ripening_time} حتى ينضج',
                                  style: TextStyle(
                                    color: Colors.black,
                                    fontFamily: 'Montserrat',
                                    fontWeight: FontWeight.bold,
